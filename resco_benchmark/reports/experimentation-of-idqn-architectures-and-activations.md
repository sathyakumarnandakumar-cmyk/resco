...
For comparison with other agents (IPPO, IMA2C), we also report the average performance across all 150+ training/validation episodes:
- **Throughput**: ~3321 Veh/Episode
- **Delay Index (TTI)**: ~3.51
- *Note: Training averages are naturally lower than peak validation performance due to exploration and learning phases.*
...
*   **Efficiency**: Achieved the lowest **Delay Index (2.38)**, meaning it maintains traffic flow closest to free-flow conditions.
